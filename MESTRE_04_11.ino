...
const byte address[6] = "00001";  // endereço de comunicação servo1
const byte address[6] = "00002";  // endereço de comunicação servo2
const byte address[6] = "00003";  // endereço de comunicação servo3
const byte address[6] = "00004";  // endereço de comunicação servo4
const byte address[6] = "00005";  // endereço de comunicação servo5
